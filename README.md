...
- 🔐 Browser wallet support (Wander or other wallet providers) for secure signing
...
Options:
  ...
  --use-browser-wallet          Use browser wallet (Wander or other wallet providers) for signing transactions.
...
#### Example: Deploy with browser wallet (Wander or other wallet providers)
...
3. Connect to Wander or other wallet providers
